...
public class ProductMovementResourceTest {
	...
	private ResponseEntity<ProductMovementDTO> getProductMovement(String url) {
		return rest.exchange(url, HttpMethod.GET, new HttpEntity<>(getHeaders("Email 1", "Senha 1")),
	...
	public void insertProductMovementTest() {
		...
		ResponseEntity<ProductMovementDTO> responseEntity = rest.exchange("/productMovement", HttpMethod.POST,
				requestEntity, ProductMovementDTO.class);
	...
	public void updateProductMovementTest() {
		...
		HttpHeaders headers = getHeaders("Email 1", "Senha 1");
		HttpEntity<ProductMovementDTO> requestEntity = new HttpEntity<>(dto, headers);
		ResponseEntity<ProductMovementDTO> responseEntity = rest.exchange("/productMovement/1", HttpMethod.PUT,
				requestEntity, ProductMovementDTO.class);
		assertEquals(HttpStatus.OK, responseEntity.getStatusCode());
		ProductMovementDTO pm = responseEntity.getBody();
		assertEquals(199.0, pm.getPrice());
	...
	public void deleteTest() {
		...
		ResponseEntity<Void> responseEntity = rest.exchange("/productMovement/1", HttpMethod.DELETE, requestEntity,
				Void.class);
