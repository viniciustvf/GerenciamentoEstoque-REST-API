...
public class ProductMovementServiceTest extends BaseTests {
	...
	void insertProductMovementTest() {
		ProductMovement productMovement = new ProductMovement(null, 20.0, 2, productService.findById(1),
				movementService.findById(1));
		...
		ProductMovement productMovement2 = new ProductMovement(null, 20.0, 2, productService.findById(2),
				movementService.findById(2));
		...
		ProductMovement productMovement5 = new ProductMovement(null, 20.0, null, productService.findById(1),
				movementService.findById(2));
		...
		ProductMovement productMovement6 = new ProductMovement(null, 20.0, 101, productService.findById(1),
				movementService.findById(2));
	...
	void updateProductMovementTest() {
		ProductMovement productMovement = new ProductMovement(1, 20.0, 2, productService.findById(2),
				movementService.findById(2));
