...
public class MovementServiceTest extends BaseTests {
    ...
    void insertMovementTest() {
    	ZonedDateTime dateTime = ZonedDateTime.of(LocalDateTime.of(2025, 1, 1, 20, 30, 5), ZoneId.of("America/Sao_Paulo"));
        ...
        ZonedDateTime dateTime2 = ZonedDateTime.of(LocalDateTime.of(2021, 1, 1, 20, 30, 5), ZoneId.of("America/Sao_Paulo"));
    ...
    void updateMovementTest() {
    	ZonedDateTime dateTime = ZonedDateTime.of(LocalDateTime.of(2026, 1, 1, 20, 30, 5), ZoneId.of("America/Sao_Paulo"));
    ...
    void findByDateTimeTest() {
        var lista = service.findByDateTime(ZonedDateTime.of(LocalDateTime.of(2024, 1, 1, 20, 30, 5), ZoneId.of("America/Sao_Paulo")));
        assertEquals(1, lista.size());
        var exception = assertThrows(ObjectNotFound.class, () -> service.findByDateTime(ZonedDateTime.of(LocalDateTime.of(2028, 1, 1, 20, 30, 5), ZoneId.of("America/Sao_Paulo"))));
        assertEquals("Nenhum movimento encontrado na data 2028-01-01T20:30:05-03:00[America/Sao_Paulo]", exception.getMessage());
    }
